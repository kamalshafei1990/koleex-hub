...
/* ---------------------------------------------------------------------------
   ...
   Same shape as FinanceHeader: back arrow, app icon, h1 + subtitle,
   action slot, and a grouped tab row beneath. Inventory is a small
   module so its tabs are flat (no two-row pattern needed yet).
   --------------------------------------------------------------------------- */
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] text-[var(--text-dim)]">
            <RrIcon name="badge-check" size={16} />
          </div>
