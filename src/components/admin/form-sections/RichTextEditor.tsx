    ...
    <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-surface-subtle)]/40 overflow-hidden focus-within:border-[var(--border-focus)] transition-colors">
      ...
      >
        ...
        <div className="relative">
          ...
          {showSizes && (
            <div className="kx-glass-pop kx-pop-panel absolute top-full left-0 mt-1 z-30 py-1 min-w-[140px]">
              {FONT_SIZES.map((s) => (
        ...
        <div className="relative">
          ...
          {showColors && (
            <div className="kx-glass-pop kx-pop-panel absolute top-full left-0 mt-1 z-30 p-2 grid grid-cols-6 gap-1.5">
              {COLORS.map((c) => (
        ...
        footer={
          <>
            ...
            <button
              ...
              className="h-10 px-5 rounded-xl bg-[var(--bg-inverted)] text-[var(--text-inverted)] text-[13px] font-semibold transition-all shadow-lg disabled:opacity-40"
            >
              Insert
            </button>
          </>
        ...
        footer={
          <>
            ...
            <button
              ...
              className="h-10 px-5 rounded-xl bg-[var(--bg-inverted)] text-[var(--text-inverted)] text-[13px] font-semibold inline-flex items-center gap-2 transition-all shadow-lg disabled:opacity-40"
            >
