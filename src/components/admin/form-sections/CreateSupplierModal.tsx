    ...
    <Modal
      ...
      footer={
        <>
          ...
          <button onClick={handleSave} disabled={saving || !companyNameEn.trim()} className="h-10 px-5 rounded-xl bg-[var(--bg-inverted)] text-[var(--text-inverted)] text-[13px] font-semibold flex items-center gap-2 transition-all shadow-lg disabled:opacity-40">
