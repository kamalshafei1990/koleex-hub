...
const COMPANY_ASSETS: { label: string; src: string; dark?: boolean }[] = [
  { label: "Hub logo · light", src: "/brand/hub-logo/koleex-hub-logo-for-light-c.png" },
  { label: "Hub logo · dark", src: "/brand/hub-logo/koleex-hub-logo-for-dark-c.png", dark: true },
  { label: "Stacked · light", src: "/brand/hub-logo/koleex-hub-stacked-for-light-c.png" },
  { label: "Stacked · dark", src: "/brand/hub-logo/koleex-hub-stacked-for-dark-c.png", dark: true },
  { label: "Mono · light", src: "/brand/hub-logo/koleex-hub-logo-mono-light-c.png" },
  { label: "Mono · dark", src: "/brand/hub-logo/koleex-hub-logo-mono-dark-c.png", dark: true },
  { label: "Script", src: "/brand/hub-logo/hub-script-c.png", dark: true },
