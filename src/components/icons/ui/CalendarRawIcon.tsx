...
const CalendarRawIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties }>(
...
CalendarRawIcon.displayName = "CalendarRawIcon";
export default CalendarRawIcon;
