...
const ForwardMsgIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties }>(
...
ForwardMsgIcon.displayName = "ForwardMsgIcon";
export default ForwardMsgIcon;
