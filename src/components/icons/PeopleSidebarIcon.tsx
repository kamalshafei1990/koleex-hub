...
const PeopleSidebarIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties; strokeWidth?: number }>(
...
PeopleSidebarIcon.displayName = "PeopleSidebarIcon";
export default PeopleSidebarIcon;
