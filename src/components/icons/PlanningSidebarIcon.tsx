...
const PlanningSidebarIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties; strokeWidth?: number }>(
...
PlanningSidebarIcon.displayName = "PlanningSidebarIcon";
export default PlanningSidebarIcon;
