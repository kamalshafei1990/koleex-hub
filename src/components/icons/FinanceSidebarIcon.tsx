...
const FinanceSidebarIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties; strokeWidth?: number }>(
...
FinanceSidebarIcon.displayName = "FinanceSidebarIcon";
export default FinanceSidebarIcon;
