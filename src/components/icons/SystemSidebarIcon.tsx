...
const SystemSidebarIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties; strokeWidth?: number }>(
...
SystemSidebarIcon.displayName = "SystemSidebarIcon";
export default SystemSidebarIcon;
