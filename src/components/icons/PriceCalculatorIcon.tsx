...
const PriceCalculatorIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties; strokeWidth?: number }>(
...
PriceCalculatorIcon.displayName = "PriceCalculatorIcon";
export default PriceCalculatorIcon;
