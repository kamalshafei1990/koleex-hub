...
/* ProductDataIcon — custom SVG for the internal /product-data app.
   Sourced from Icons/Products adata.svg. Same sizing + color API as
   ProductsIcon so it slots cleanly into the sidebar + launcher. */
const ProductDataIcon = forwardRef<
  SVGSVGElement,
...
ProductDataIcon.displayName = "ProductDataIcon";
export default ProductDataIcon;
