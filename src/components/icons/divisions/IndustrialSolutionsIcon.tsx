...
const IndustrialSolutionsIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties }>(
...
IndustrialSolutionsIcon.displayName = "IndustrialSolutionsIcon";
export default IndustrialSolutionsIcon;
