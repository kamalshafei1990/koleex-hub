...
const DigitalDevicesIcon = forwardRef<SVGSVGElement, { size?: number | string; className?: string; style?: React.CSSProperties }>(
...
DigitalDevicesIcon.displayName = "DigitalDevicesIcon";
