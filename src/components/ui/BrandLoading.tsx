      ...
      <div className="kx-brand-load" aria-hidden>
        ...
        <span className="kx-orb kx-orb--page">
          ...
          <span className="kx-orb-mark">
            ...
            <img src="/brand/hub-logo/koleex-hub-logo-for-dark-e.webp" alt="" className="kx-brand-logo-dark" />
            {/* eslint-disable-next-line @next/next/no-img-element -- theme twin of the above */}
            <img src="/brand/hub-logo/koleex-hub-logo-for-light-e.webp" alt="" className="kx-brand-logo-light" />
