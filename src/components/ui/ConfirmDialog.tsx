...
export default function ConfirmDialog({
  ...
  return (
    ...
    >
      <div
        className={`kx-app kx-glass-pop kx-pop-in ${closing ? "kx-pop-closing" : ""} relative w-full max-w-sm rounded-2xl border border-white/[0.08] bg-[var(--bg-secondary)] shadow-[0_24px_64px_-24px_rgba(0,0,0,0.7)]`}
