  ...
  return (
    ...
    >
      <div
        ...
        className="kx-app kx-glass-pop kx-pop-in relative flex h-full w-full flex-col overflow-hidden bg-[var(--bg-primary)] text-[var(--text-primary)] shadow-2xl sm:h-auto sm:max-h-[88vh] sm:w-[min(740px,92vw)] sm:rounded-2xl sm:border sm:border-[var(--border-color)]"
      >
        {/* Header */}
