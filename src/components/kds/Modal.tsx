...
export default function Modal({
  ...
  return (
    ...
    >
      <div
        className={`kx-app kx-glass-pop kx-pop-in ${closing ? "kx-pop-closing" : ""} relative w-full ${maxWidth} space-y-4 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] p-5 max-h-[88vh] overflow-y-auto`}
