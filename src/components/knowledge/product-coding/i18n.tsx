...
const LBL: Record<string, Record<Lang, string>> = {
  ...
  "Ultrasonic Sewing Machines": { en: "Ultrasonic Sewing Machines", zh: "超声波缝纫机", ar: "ماكينات اللحام بالموجات فوق الصوتية" },
  "Elastic Attaching Machines": { en: "Elastic Attaching Machines", zh: "松紧带机", ar: "ماكينات تركيب الأستك" },
  "Template Sewing Machines": { en: "Template Sewing Machines", zh: "模板缝纫机", ar: "ماكينات الخياطة بالقوالب" },
  "Tape Attaching Units": { en: "Tape Attaching Units", zh: "全自动贴条机", ar: "وحدات لصق الشرائط الآلية" },
  "Pintuck Sewing Units": { en: "Pintuck Sewing Units", zh: "全自动打条机", ar: "وحدات خياطة الكسرات الآلية" },
  "Belt Loop Attaching Units": { en: "Belt Loop Attaching Units", zh: "自动带襻机", ar: "وحدات تركيب عراوي الحزام الآلية" },
  "Dart Sewing Units": { en: "Dart Sewing Units", zh: "自动收省机", ar: "وحدات خياطة البنس الآلية" },
  "Glue Dispensing Machines": { en: "Glue Dispensing Machines", zh: "点胶机", ar: "ماكينات توزيع الغراء" },
  "Garment Prep Units": { en: "Garment Prep Units", zh: "缝前准备单元", ar: "وحدات تجهيز الخياطة" },
  "Fur Sewing Machines": { en: "Fur Sewing Machines", zh: "毛皮缝纫机", ar: "ماكينات خياطة الفراء" },
  "Bra Hardware Machines": { en: "Bra Hardware Machines", zh: "内衣五金机", ar: "ماكينات خردوات اللانجري" },
  // XSE
