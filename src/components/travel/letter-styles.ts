...
export const LETTER_STYLES = `
  ...
  .inv-a4 {
    ...
    /* THE WATERMARK — the owner's Feiyue letter tiles the company mark
       ...
       the letterhead logo, at 8% black — 4% read as barely there next to the Feiyue
       reference; 8% is visibly present and text stays fully readable.
