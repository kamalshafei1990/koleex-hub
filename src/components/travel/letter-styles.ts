...
export const LETTER_STYLES = `
  ...
  .inv-a4 {
    ...
    /* THE WATERMARK — the owner's Feiyue letter tiles the company mark
       ...
       letterhead logo's own SVG paths at 12% black — the owner asked
       twice for more presence; 12% is assertive but the 9pt body text over
       it stays comfortably readable.
