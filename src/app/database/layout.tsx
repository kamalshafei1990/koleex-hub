...
const T: Translations = {
  ...
  "db.page.specsAttributes.title": { en: "Specs & Attributes", zh: "规格与属性", ar: "المواصفات والسمات" },
  "db.page.specsAttributes.sub": { en: "Visuals for product spec fields, values and commercial attributes — Icon · Photo · Text · Icon+Text.", zh: "产品规格字段、取值与商业属性的视觉 — 图标 · 图片 · 文本 · 图标+文本。", ar: "بصريات حقول وقيم مواصفات المنتج والسمات التجارية — أيقونة · صورة · نص · أيقونة+نص." },
