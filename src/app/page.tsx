        ...
        isAi
          ...
          : app.active
            ? isCurrentApp
              ...
              : `cursor-pointer group border ${
                  dk
                    ? "bg-[#111] border-white/[0.06] hover:border-[#567fb2]/60 hover:bg-[#1a1a1a] hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(0,0,0,0.6)]"
                    : "bg-white border-black/[0.06] hover:border-[#567fb2]/50 hover:bg-[#fafafa] hover:scale-[1.02] hover:shadow-[0_8px_30px_rgba(0,0,0,0.08)]"
                }`
