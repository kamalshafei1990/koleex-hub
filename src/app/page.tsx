...
const DAILY_QUOTES: Record<string, string[]> = {
  en: [
    ...
    "Dream big, start small — but above all, start.",
    ...
    "Your only limit is the one you place on yourself.",
    ...
    "Quality is doing it right even when no one is watching.",
    "Believe in yourself and all that you are.",
  ],
  zh: [
    "当天赋不努力时，努力终将胜出。",
    "成功，是日复一日小小努力的累积。",
    "做出色工作的唯一方法，就是热爱你所做的事。",
    "梦想要大，起步可小——但最重要的是，开始。",
    "你的未来，由今天的行动创造，而非明天。",
    "别只盯着时钟；要像它一样——不停前行。",
    "你为一件事付出越多，达成时的喜悦就越大。",
  ...
  ar: [
    "الاجتهاد يتغلّب على الموهبة حين لا تجتهد الموهبة.",
    "النجاح حصيلة جهود صغيرة تتكرّر يومًا بعد يوم.",
    "الطريق الوحيد للعمل العظيم أن تحبّ ما تفعله.",
    "احلم كبيرًا، وابدأ صغيرًا — والأهمّ من كل شيء… ابدأ.",
    "مستقبلك يصنعه ما تفعله اليوم، لا غدًا.",
    "لا تراقب الساعة؛ افعل كما تفعل هي — واصل المسير.",
    "كلما اجتهدت أكثر لأجل شيء، كان شعورك بتحقيقه أعظم.",
    "آمِن بأنك تستطيع، فتكون قد قطعت نصف الطريق.",
    "الفرص لا تأتي صدفة — أنت من يصنعها.",
    "الانضباط هو الجسر بين الأهداف وتحقيقها.",
    "تقدّم بسيط كل يوم يصنع نتائج عظيمة.",
    "اعمل بصمت، ودع نجاحك يتكلّم.",
    "سرّ التقدّم أن تبدأ.",
    "لا تحدّ من تحدّياتك — بل تحدَّ حدودك.",
    "الأشياء العظيمة لا تولد من مناطق الراحة.",
    "ادفع نفسك، فلن يفعل ذلك أحد غيرك.",
    "النجاح لا يأتي إليك؛ أنت من يذهب إليه.",
    "كل خبير في مجاله كان يومًا مبتدئًا.",
    "تحلَّ بالصبر، وثِق برحلتك.",
    "استيقظ بعزيمة، ونم على رضا.",
    "ما لا يتحدّاك، لن يغيّرك.",
    "كن بارعًا إلى حدٍّ يستحيل معه تجاهلك.",
    "خطوات صغيرة كل يوم تصنع نتائج كبيرة مع الوقت.",
    "لا تتوقّف حين تتعب — توقّف حين تنتهي.",
    "حدّك الوحيد هو ذاك الذي تضعه لنفسك.",
    "الأيام الصعبة تصنع أناسًا أقوياء.",
    "ركّز على أن تكون منتجًا، لا مجرد مشغول.",
    "اجعل كل يوم تحفتك الخاصة.",
    "الفرق بين العادي والاستثنائي هو ذلك «القليل الإضافي».",
    "افعل اليوم ما يشكرك عليه نفسك في المستقبل.",
    "الطاقة والمثابرة تقهران كل شيء.",
    "لا تتمنَّ أن يكون الأمر أسهل؛ تمنَّ أن تكون أقوى.",
    "النجاح من نصيب المنشغلين عن البحث عنه.",
    "أفضل وسيلة للتنبؤ بالمستقبل أن تصنعه.",
    "الفعل هو المفتاح الأساسي لكل نجاح.",
    "إن سقطت سبعًا، فانهض ثمانيًا.",
    "اعمل من أجل هدف، لا من أجل التصفيق.",
    "كل إنجاز يبدأ بقرار المحاولة.",
    "الجودة أن تُتقن العمل حتى حين لا يراك أحد.",
    "آمِن بنفسك وبكل ما أنت عليه.",
  ],
};
