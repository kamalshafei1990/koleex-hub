  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        >
          <svg width={188} height={28} viewBox="0 0 719.83 107.57" fill="#FFFFFF" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          {photo ? (
            ...
            <img src={photo} alt="" style={{ maxWidth: "100%", maxHeight: 500, objectFit: "contain" }} width={560} height={500} />
          ) : null}
        </div>
      </div>
    ),
