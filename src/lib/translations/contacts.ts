...
export const contactsT: Translations = {
  ...
  "sd.groupProfile": { en: "Profile & operations", zh: "概况与运营", ar: "الملف التعريفي والعمليات" },
  ...
  "supgroup.production": { en: "Production & quality", zh: "生产与质量", ar: "الإنتاج والجودة" },
  ...
  "sd.groupCommercial": { en: "Commercial intelligence", zh: "商业情报", ar: "المعلومات التجارية" },
  "sd.groupRecords": { en: "Records & documents", zh: "记录与文档", ar: "السجلات والمستندات" },
