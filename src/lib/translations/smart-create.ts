...
export const smartCreateT: Translations = {
  ...
  "sc.so":            { en: "Sales Order",               zh: "销售订单",               ar: "أمر بيع" },
  "sc.so.h":          { en: "Commit to ship to a customer", zh: "向客户承诺发货",      ar: "التزام بالشحن لعميل" },
  "sc.bill":          { en: "Vendor Bill",               zh: "供应商账单",             ar: "فاتورة مورد" },
  "sc.bill.h":        { en: "Bill received from a supplier", zh: "收到的供应商账单",   ar: "فاتورة واردة من مورد" },
