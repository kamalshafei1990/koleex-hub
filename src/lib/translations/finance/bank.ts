...
export const FIN_BANK: Translations = {
  ...
  "bank.field.balancesHidden": { en: "Balances are shown and set only with «Bank & Profit» in Roles & Permissions.",
                                  zh: "只有在角色与权限中拥有「Bank & Profit」才能查看和设置余额。",
                                  ar: "الأرصدة تُعرض وتُضبط فقط مع «Bank & Profit» في الأدوار والصلاحيات." },
