...
export const inventoryT: Translations = {
  ...
  /* ── Moved out of InventoryItems' file-local INV_H1_T dictionary ──────
     It shadowed the app dict: its `inv.title` said "Stock Profiles" while
     this file's says "Inventory". Merging blind would have silently
     retitled the screen, so the local one moved in as `inv.items.title`.
     `inv.loading` was identical and simply dropped. */
  "inv.items.title":             { en: "Stock Profiles",   zh: "库存档案",       ar: "ملفات المخزون" },
  ...
  /* InventoryItems — the 43 strings the W3 pass found bare. */
  "inv.items.clear": { en: "Clear", zh: "清除", ar: "مسح" },
  "inv.items.all_types": { en: "All types", zh: "全部类型", ar: "كل الأنواع" },
  "inv.items.status": { en: "Status", zh: "状态", ar: "الحالة" },
  "inv.items.archived": { en: "Archived", zh: "已归档", ar: "مؤرشف" },
  "inv.items.uom": { en: "UoM", zh: "单位", ar: "وحدة القياس" },
  "inv.items.subcategory": { en: "Subcategory", zh: "子类别", ar: "الفئة الفرعية" },
  "inv.items.unit_of_measure": { en: "Unit of Measure", zh: "计量单位", ar: "وحدة القياس" },
  "inv.items.initial_qty": { en: "Initial Qty (optional)", zh: "初始数量（可选）", ar: "الكمية الابتدائية (اختياري)" },
  "inv.items.warehouse": { en: "Warehouse", zh: "仓库", ar: "المخزن" },
  "inv.items.restore": { en: "Restore", zh: "恢复", ar: "استعادة" },
  "inv.items.archive": { en: "Archive", zh: "归档", ar: "أرشفة" },
  "inv.items.consumable": { en: "Consumable", zh: "易耗品", ar: "مستهلك" },
  "inv.items.sellable": { en: "Sellable", zh: "可销售", ar: "قابل للبيع" },
  "inv.items.stock": { en: "Stock", zh: "库存", ar: "المخزون" },
  "inv.items.valuation": { en: "Valuation", zh: "计价", ar: "التقييم" },
  "inv.items.stock_value": { en: "Stock value", zh: "库存金额", ar: "قيمة المخزون" },
  "inv.items.last_in_cost": { en: "Last in cost", zh: "最近入库成本", ar: "تكلفة آخر وارد" },
  "inv.items.details": { en: "Details", zh: "详情", ar: "التفاصيل" },
  "inv.items.description": { en: "Description", zh: "描述", ar: "الوصف" },
  "inv.items.new_custom_type": { en: "New custom type", zh: "新建自定义类型", ar: "نوع مخصّص جديد" },
  "inv.items.icon": { en: "Icon", zh: "图标", ar: "الأيقونة" },
  "inv.items.color": { en: "Color", zh: "颜色", ar: "اللون" },
  "inv.items.variants": { en: "Variants", zh: "款式", ar: "المتغيّرات" },
  "inv.items.add_variant": { en: "Add variant", zh: "添加款式", ar: "إضافة متغيّر" },
  "inv.items.voltage": { en: "Voltage", zh: "电压", ar: "الجهد" },
  "inv.items.size": { en: "Size", zh: "尺寸", ar: "المقاس" },
  "inv.items.attributes": { en: "Attributes", zh: "属性", ar: "الخصائص" },
  "inv.items.cost": { en: "Cost", zh: "成本", ar: "التكلفة" },

  /* Final W3 sweep — the last bare strings across the inventory screens. */
  "inv.mv.raw_status": { en: "Raw status", zh: "原始状态", ar: "الحالة الخام" },
  "inv.mv.raw_type": { en: "Raw type", zh: "原始类型", ar: "النوع الخام" },
  "inv.role.manager": { en: "Manager", zh: "管理员", ar: "مدير" },
  "inv.nav.balances": { en: "Balances", zh: "库存余额", ar: "الأرصدة" },
  "inv.nav.ledger": { en: "Movements ledger", zh: "出入库台账", ar: "دفتر الحركات" },
  "inv.common.next": { en: "Next", zh: "下一步", ar: "التالي" },
  "inv.common.date": { en: "Date", zh: "日期", ar: "التاريخ" },
  "inv.common.reference": { en: "Reference", zh: "参考号", ar: "المرجع" },
  "inv.common.reason": { en: "Reason", zh: "原因", ar: "السبب" },
  "inv.common.out": { en: "Out", zh: "出库", ar: "صادر" },
  "inv.mv.movement": { en: "Movement", zh: "出入库", ar: "الحركة" },
  "inv.common.item_code": { en: "Item code", zh: "物料编码", ar: "كود الصنف" },
  "inv.mv.approval": { en: "Approval", zh: "审批", ar: "الموافقة" },
  "inv.mv.sales_shipment": { en: "Sales shipment", zh: "销售发货", ar: "شحنة مبيعات" },
  "inv.mv.invoice": { en: "Invoice", zh: "发票", ar: "فاتورة" },
  "inv.mv.purchase_receipt": { en: "Purchase receipt", zh: "采购入库", ar: "إيصال شراء" },
  "inv.mv.vendor_bill": { en: "Vendor bill", zh: "供应商账单", ar: "فاتورة مورّد" },
  "inv.items.empty_internal": { en: "No internal-use items yet. Create one from", zh: "暂无内部使用物料。可从此处创建", ar: "لا توجد أصناف للاستخدام الداخلي بعد. أنشئ واحدًا من" },
  "inv.common.filters":          { en: "Filters",           zh: "筛选",         ar: "عوامل التصفية" },

  /* Text sitting NEXT TO a JSX expression — structurally invisible to a
     >text< scan, which is why these five outlived the first sweep. */
