...
const DOUBLE_NEEDLE_KINDS: MachineKind[] = [
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", needle_bar: "fixed" },
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", needle_bar: "split" },
    templateSlug: "double-needle-lockstitch",
    icon: DoubleNeedleIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", feed: "needle" },
    templateSlug: "double-needle-lockstitch",
    icon: DoubleNeedleIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", feed: "walking-foot" },
    templateSlug: "double-needle-lockstitch",
    icon: WalkingFootMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", arm: "long" },
    templateSlug: "double-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed: "post" },
    templateSlug: "double-needle-lockstitch",
    icon: PostBedMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed: "cylinder" },
    templateSlug: "double-needle-lockstitch",
    icon: CylinderBedMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed: "feed-off-arm" },
    templateSlug: "double-needle-lockstitch",
    icon: FeedOffArmMachineIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", duty: "heavy" },
    templateSlug: "double-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
];
...
const PATTERN_SEWING_KINDS: MachineKind[] = [
  {
    ...
    attributes: { working_field: "small" },
  ...
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { working_field: "medium" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { working_field: "large" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { working_field: "xxl", arm: "long" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "pocket-welting-machines",
    attributes: { welt: "double", flap: "yes" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
...
const HEAVY_DUTY_KINDS: MachineKind[] = [
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", needle_count: "2" },
    templateSlug: "single-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", feed: "walking-foot" },
    templateSlug: "single-needle-lockstitch",
    icon: WalkingFootMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", arm: "long" },
    templateSlug: "single-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", bed: "post" },
    templateSlug: "single-needle-lockstitch",
    icon: PostBedMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", bed: "cylinder" },
    templateSlug: "single-needle-lockstitch",
    icon: CylinderBedMachineIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", application: "tape-edge" },
    templateSlug: "single-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { duty: "heavy", application: "carpet-binding" },
    templateSlug: "single-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
];
...
const SPECIAL_KINDS: MachineKind[] = [
  {
    ...
    attributes: { buttonhole: "straight" },
  ...
  },
  {
    ...
    subcategory: "buttonhole-machines",
    attributes: { buttonhole: "eyelet-keyhole" },
    templateSlug: "button-hole",
    icon: ButtonholeMachineIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "tape-edge-mattress", duty: "heavy" },
    templateSlug: "single-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
