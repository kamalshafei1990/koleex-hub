...
export interface MachineKind {
  ...
  name: string;
  description: string;
  /** The STITCH TYPE this kind is a preset of. Not where it was historically
   *  filed — CL-0020 re-pointed every kind whose old subcategory described a
   *  configuration (needle count, duty) rather than a stitch. */
  subcategory: string;
  /** The attribute values that, together with `subcategory`, ARE this kind.
   *  A Kind is Type x attributes; this is the second axis. Reading
   *  `{needle_count:"2", duty:"heavy"}` on a lockstitch tells you everything
...
const DOUBLE_NEEDLE_KINDS: MachineKind[] = [
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", needle_bar_type: "fixed" },
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", needle_bar_type: "split" },
    templateSlug: "double-needle-lockstitch",
    icon: DoubleNeedleIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", feed_type: "needle" },
    templateSlug: "double-needle-lockstitch",
    icon: DoubleNeedleIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", feed_type: "walking-foot" },
    templateSlug: "double-needle-lockstitch",
    icon: WalkingFootMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed_type: "long-arm" },
    templateSlug: "double-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed_type: "post" },
    templateSlug: "double-needle-lockstitch",
    icon: PostBedMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed_type: "cylinder" },
    templateSlug: "double-needle-lockstitch",
    icon: CylinderBedMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", bed_type: "feed-off-arm" },
    templateSlug: "double-needle-lockstitch",
    icon: FeedOffArmMachineIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "2", fabric_weight_class: "heavy" },
    templateSlug: "double-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
];
...
const MULTI_NEEDLE_KINDS: MachineKind[] = [
  ...
  },
  {
    ...
    subcategory: "chainstitch-machines",
    attributes: { needle_count: "multi", application: "picot-fagoting" },
    templateSlug: "double-needle-lockstitch",
    icon: MultiNeedleIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { needle_count: "multi", application: "quilting" },
    templateSlug: "double-needle-lockstitch",
    icon: MultiNeedleIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "chainstitch-machines",
    attributes: { needle_count: "multi", application: "elastic-attaching" },
    templateSlug: "double-needle-lockstitch",
    icon: MultiNeedleIcon,
  },
];
...
const PATTERN_SEWING_KINDS: MachineKind[] = [
  {
    ...
    attributes: { working_field_class: "small" },
  ...
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { working_field_class: "medium" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { working_field_class: "large" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { working_field_class: "xxl", bed_type: "long-arm" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "pocket-welting-machines",
    attributes: { welt_count: "single" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "pocket-welting-machines",
    attributes: { welt_count: "double", flap_handling: "true" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { application: "belt-loop-attaching" },
    templateSlug: "bartacking",
    icon: BartackIcon,
  },
  {
    ...
    subcategory: "sleeve-setting-machines",
    templateSlug: "bartacking",
    icon: AutomaticMachineIcon,
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { application: "waistband-attaching" },
    templateSlug: "bartacking",
    icon: AutomaticMachineIcon,
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { application: "label-patch" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
  {
    ...
    subcategory: "bartacking-machines",
    attributes: { automation_level: "programmable" },
    templateSlug: "bartacking",
    icon: BartackIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "programmable-cnc-sewing",
    attributes: { template_recognition: "rfid" },
    templateSlug: "bartacking",
    icon: PatternSewerIcon,
  },
];
...
const HEAVY_DUTY_KINDS: MachineKind[] = [
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", needle_count: "2" },
    templateSlug: "single-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", feed_type: "walking-foot" },
    templateSlug: "single-needle-lockstitch",
    icon: WalkingFootMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", bed_type: "long-arm" },
    templateSlug: "single-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", bed_type: "post" },
    templateSlug: "single-needle-lockstitch",
    icon: PostBedMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", bed_type: "cylinder" },
    templateSlug: "single-needle-lockstitch",
    icon: CylinderBedMachineIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "extra-heavy" },
    templateSlug: "single-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", application: "tape-edge" },
    templateSlug: "single-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { fabric_weight_class: "heavy", application: "carpet-binding" },
    templateSlug: "single-needle-lockstitch",
    icon: HeavyDutyMachineIcon,
  },
];
...
const SPECIAL_KINDS: MachineKind[] = [
  {
    ...
    subcategory: "buttonhole-machines",
    attributes: { buttonhole_type: "straight" },
  ...
  },
  {
    ...
    subcategory: "buttonhole-machines",
    attributes: { buttonhole_type: "eyelet-keyhole" },
    templateSlug: "button-hole",
    icon: ButtonholeMachineIcon,
  },
  {
    ...
    subcategory: "button-attaching-machines",
  ...
  },
  {
    ...
    subcategory: "blindstitch-machines",
    templateSlug: "single-needle-lockstitch",
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "smocking-shirring" },
    templateSlug: "double-needle-lockstitch",
    icon: MultiNeedleIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "picot-scallop" },
    templateSlug: "single-needle-lockstitch",
    icon: SpecialMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "pleating" },
    templateSlug: "single-needle-lockstitch",
    icon: SpecialMachineIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "elastic-cording" },
    templateSlug: "double-needle-lockstitch",
    icon: MultiNeedleIcon,
  },
  {
  ...
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "basting" },
    templateSlug: "single-needle-lockstitch",
    icon: SpecialMachineIcon,
  },
  {
    ...
    subcategory: "lockstitch-machines",
    attributes: { application: "tape-edge-mattress", fabric_weight_class: "heavy" },
    templateSlug: "single-needle-lockstitch",
    icon: LongArmMachineIcon,
  },
  {
