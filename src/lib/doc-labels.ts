...
const LABELS = {
  ...
  "terms.shipmentDetails": { en: "Shipment & Delivery Details", zh: "装运与交货明细" },
  "ship.loadingPort":      { en: "Loading Port",        zh: "装运港" },
  "ship.dischargePort":    { en: "Discharge Port",      zh: "卸货港" },
  "ship.sentBy":           { en: "Sent By",             zh: "运输方式" },
  "ship.containerType":    { en: "Container Type",      zh: "柜型" },
  "ship.shippingMarks":    { en: "Shipping Marks",      zh: "唛头" },
  "ship.leadTime":         { en: "Lead Time",           zh: "交货期" },
  "ship.deliveryTime":     { en: "Delivery Time",       zh: "运输时效" },
  "ship.countryOfOrigin":  { en: "Country of Origin",   zh: "原产国" },
  "ship.netWeight":        { en: "Net Weight",          zh: "净重" },
  "ship.grossWeight":      { en: "Gross Weight",        zh: "毛重" },
  "ship.cbm":              { en: "CBM",                 zh: "体积 (CBM)" },
  "ship.packages":         { en: "No. of Packages",     zh: "件数" },
  "ship.documents":        { en: "Documents",           zh: "随附单据" },
  "ship.totalQty":         { en: "Total Qty",           zh: "总数量" },
