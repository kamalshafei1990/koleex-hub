...
export const PRODUCTS_UI_I18N: Translations = {
  ...
  "hero.featured": { en: "Featured", zh: "精选", ar: "مميّز" },
  "hero.feature": { en: "Feature", zh: "设为精选", ar: "تمييز" },
  "hero.featuredOnHome": { en: "Featured on homepage", zh: "已在首页精选", ar: "مميّز في الصفحة الرئيسية" },
  "hero.clickToFeature": { en: "Click to feature on homepage", zh: "点击以在首页精选", ar: "انقر للتمييز في الصفحة الرئيسية" },
  ...
  "review.featured": { en: "Featured", zh: "精选", ar: "مميّز" },
