...
export const PRODUCTS_UI_I18N: Translations = {
  ...
  "mv.packingMoved": { en: "Packing, weights and container loading for this model are entered on the Packing & Logistics tab, with the model selected in the family strip.", zh: "该型号的包装、重量与装柜数量在「包装与物流」页签填写——先在系列条中选中该型号。", ar: "تعبئة هذا الموديل وأوزانه وتحميل الحاويات تُدخل في تبويب التعبئة واللوجستيات بعد اختيار الموديل من شريط العائلة." },
  "mv.openPacking": { en: "Open Packing & Logistics", zh: "打开包装与物流", ar: "افتح التعبئة واللوجستيات" },
