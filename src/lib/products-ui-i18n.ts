...
export const PRODUCTS_UI_I18N: Translations = {
  ...
  "pk.packagesPerUnit":  { en: "Packages per unit", zh: "每台包装件数", ar: "الطرود لكل وحدة" },
  ...
  "pk.containerCap":     { en: "{cbm} m³ · {kg} kg payload", zh: "{cbm} m³ · 载重 {kg} kg", ar: "{cbm} م³ · حمولة {kg} كجم" },
  ...
  "pk.netFromMachine":   { en: "The machine weight from Physical — suppliers quote N.W. and G.W., and N.W. is the machine.", zh: "取自“物理”中的机器重量 — 供应商只给净重/毛重，净重即机器。", ar: "وزن الماكينة من قسم Physical — الموردين بيكتبوا N.W. وG.W.، والـ N.W. هو الماكينة." },
