...
import { AI_PROVENANCE_RULE, PRODUCT_PHOTO_RULE, WEB_IMAGE_RULE } from "@/lib/server/ai/prompt-builder";
import {
  AI_IDENTITY_STORY,
  AI_IDENTITY_BRIEF,
