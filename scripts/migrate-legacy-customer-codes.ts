...
/* ---------------------------------------------------------------------------
   ...
   left alone by backfill-customer-codes.ts, which only fills BLANK codes —
   ...
   reading the sequence table, and never calls the allocator.
       ...
       npx tsx scripts/migrate-legacy-customer-codes.ts
       npx tsx scripts/migrate-legacy-customer-codes.ts --apply
   --------------------------------------------------------------------------- */
