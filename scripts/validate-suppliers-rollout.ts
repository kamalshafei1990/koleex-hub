...
/* validate:suppliers-rollout — the trusted server-side Suppliers cohort resolver.
   ...
   Run: NODE_OPTIONS=--conditions=react-server tsx scripts/validate-suppliers-rollout.ts */
import { isInSuppliersServerListCohort, suppliersServerListCohortSize } from "../src/lib/server/suppliers-rollout";
import * as cust from "../src/lib/server/customers-rollout";
