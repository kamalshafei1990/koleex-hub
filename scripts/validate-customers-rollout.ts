...
/* validate:customers-rollout — the trusted server-side cohort resolver.
   ...
   Run: NODE_OPTIONS=--conditions=react-server tsx scripts/validate-customers-rollout.ts */
import { isInCustomersServerListCohort, customersServerListCohortSize } from "../src/lib/server/customers-rollout";
