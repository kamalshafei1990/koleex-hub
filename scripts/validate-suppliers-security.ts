...
/* validate:suppliers-security — deterministic role/tenant/field-security coverage
   ...
   Run: NODE_OPTIONS=--conditions=react-server tsx scripts/validate-suppliers-security.ts */
import { fileURLToPath } from "node:url";
import path from "node:path";
import fs from "node:fs";
import * as cfg from "../src/lib/server-list/contacts-config";
import * as types from "../src/lib/server-list/types";
import * as apply from "../src/lib/server-list/apply";
import * as sens from "../src/lib/server/sensitive-columns";
